...
elseif(isset($_GET['pollID'])) {
	$pollID = $_GET['pollID'];
	if(ispollsadmin($userID)) echo'<input type="button" onclick="MM_goToURL(\'parent\',\'index.php?site=polls&amp;action=new\');return document.MM_returnValue" value="'.$_language->module['new_poll'].'" class="btn btn-danger" />';
